...
<body>
	<div class="container" style="width: 1230px">
		...
		<div class="row" id="centerRow">
				...
				<div class="panel-group" id="accordion" role="tablist"
					...
					<div class="panel panel-default" id="pan"
						...
						<div data-toggle="collapse" data-parent="#accordion"
							...
							aria-controls="collapseOne" class="panel-heading collapsed"
								...
								<div id="jobNames">
									<div class="row col-md-offset-1">
										...
										<div class="col-md-12" id="panel1">
											...
											<a href="#addnewjob" class="btn btn-primary"
												data-toggle="modal">Add New Job</a><br> <a href="#"
												class="btn btn-primary" data-toggle="modal">Edit Job</a><br>
											<a href="#deletejob" class="btn btn-primary"
												data-toggle="modal">Delete Job</a><br>
										</div>
				...
				<div class="panel-group" id="accordion2" role="tablist"
					...
					<div class="panel panel-default" id="pan2"
						...
						<div data-toggle="collapse" data-parent="#accordion2"
							...
							aria-controls="collapseTwo" class="panel-heading" role="tab"
							id="headingTwo"
							style="height: 40px; width: 200px; padding-left: 0px;">
							<h4 class="panel-title" style="width: 160px; float: left;">
						...
						<div id="collapseTwo" class="panel-collapse in" role="tabpanel"
							aria-labelledby="headingTwo">
							<div class="panel-body" style="background-color: white;">
								<div id="jobNames">
									<div class="row col-md-offset-1">
										<div id="panel2" class="col-md-12">
											<a href="#" class="btn btn-primary">List User</a><br> <a
												href="#adduser" class="btn btn-primary" data-toggle="modal">Add
												New User</a><br> <a href="#deleteuser"
												class="btn btn-primary" data-toggle="modal">Delete User</a><br>
			...
			<div class="col-md-8 thumbnail" id="manageJobDescriptionPanel">
				...
				<div id="show_datatable" class="panel panel-default"></div>
			</div>
		...
		<div class="modal-dialog" Style="margin: 20%, 40%, 30%, 40%;">
			<div class="modal-content">
				<div class="modal-header" style="text-align: center;">
					<button type="button" style="float: right;" class="glyphicon"
					...
					<div class="row">
						<form role="form">
							<div class="col-md-6">
								...
								<div class="form-group">
									<label for="exampleInputPassword1">Preffered Stations</label> <input
										type="text" class="form-control" id="exampleInputPassword1"
										placeholder="Enter Preffered Stations">
								</div>
							</div>
							<div class="col-md-6">

								<div class="form-group">
									<label for="exampleInputEmail1">Expected Start Time</label> <input
										type="text" class="form-control" id="exampleInputEmail1"
										placeholder="Enter Expected Start Time">
								</div>
								<div class="form-group">
							...
							<div class="row">
								<div class="col-md-8" Style="margin-left: 15px">
									<div class="form-group">
										<label for="exampleInputPassword1">Comment & other
											Information</label>
							...
							<button type="button" class="btn btn-default"
								data-dismiss="modal" Style="float: right; margin-right: 10px;">Cancel</button>
							<button type="button" class="btn btn-primary"
								Style="float: right; margin-right: 5px">Save changes</button>
	...
	<div class="modal fade" id="deletejob">
		<div class="modal-dialog" Style="margin: 20%, 40%, 30%, 40%;">
			<div class="modal-content"
				style="width: 400px; height: 202px; margin-left: 150px;">
				<div class="modal-header">
					<button type="button" style="float: right;" class="glyphicon"
						data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel"
						style="width: 300px; padding-left: 100px;">Delete Batch Job</h4>
				</div>
				<div class="modal-body">

					<form action="#">
						<div class="check" style="padding-left: 10px;">
							<img src="images/warning.jpg" />&nbsp;&nbsp;&nbsp; <b>Do you
								really want to Delete this job?</b>
						</div>
				</div>
				<div class="modal-footer" style="width: 395px; padding-top: 10px;">
					<button type="button" class="btn btn-primary"
						style="float: left; margin-left: 120px;">Delete</button>
			...
			<div class="modal-content" style="width: 650px; height: 279px;">
				<div class="modal-header">
					<button type="button" style="float: right;" class="glyphicon"
						data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel"
						style="font-family: georgia, serif; padding-left: 240px;">Add
						New User</h4>
				</div>
				<div class="modal-body">
					<form role="form">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								<label for="select" class="control-label">Select User
									Type</label> <select class="form-control" id="select">
									<option>Admin</option>
						...
						<button type="button" class="btn btn-primary"
							Style="float: right; margin-right: 5px">Create</button>
					</form>
				</div>
			...
			<div class="modal-content"
				...
				<div class="modal-header">
					<button type="button" style="float: right;" class="glyphicon"
						data-dismiss="modal" aria-hidden="true">&times;</button>
					<h4 class="modal-title" id="myModalLabel"
						style="width: 300px; padding-left: 100px;">Delete User</h4>
				</div>
				<div class="modal-body">
					...
					<div class="check" style="padding-left: 10px;">
						<img src="images/warning.jpg" />&nbsp;&nbsp;&nbsp; <b>Do you
							really want to delete this User?</b>
					</div>
				</div>
				<div class="modal-footer" style="width: 395px; padding-top: 10px;">
					<button type="button" class="btn btn-primary"
